...
class EvaRanOnCOCO(JointsDataset):
    '''
    "keypoints": {
        0: "nose",
        1: "left_eye",
    ...
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        self.idx_keypoints = np.array([ 
          24, #'Nose'
          25, 26,  #'Left Eye', 'Right Eye'
          27, 28,  #'Left Ear', 'Right Ear'
          17, 16, # 'Left Shoulder', 'Right Shoulder'
          19, 18, # 'Left Elbow', 'Right Elbow',
          21, 20, # 'Left Wrist', 'Right Wrist'
          2, 1,   # 'Left Hip', 'Right Hip'
          5, 4,   # 'Left Knee','Right Knee'
          8, 7,   #'Left Ankle', 'Right Ankle'
        ])
